USE [dwh_computer_sales];
GO

-- Stored procedures for loading DWH dimensions and the fact table from staging data.

IF OBJECT_ID('[dbo].[usp_load_dwh_dim_locations]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_locations];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_locations]
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('[dbo].[usp_load_dwh_dim_shop]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_shop];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_shop]
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('[dbo].[usp_load_dwh_dim_pc_product]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_pc_product];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_pc_product]
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('[dbo].[usp_load_dwh_dim_sales_person]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_sales_person];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_sales_person]
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('[dbo].[usp_load_dwh_dim_payment_id]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_payment_id];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_payment_id]
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('[dbo].[usp_load_dwh_dim_priority_id]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_priority_id];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_priority_id]
AS
BEGIN
    SET NOCOUNT ON;

    INSERT INTO [dbo].[dim_priority_id] (priority)
    SELECT DISTINCT
        r.[Priority]
    FROM [stg_computer_sales].[dbo].[raw_pc_data] AS r
    WHERE r.[Priority] IS NOT NULL
      AND NOT EXISTS (
          SELECT 1
          FROM [dbo].[dim_priority_id] AS d
          WHERE d.priority = r.[Priority]
      );
END;
GO

IF OBJECT_ID('[dbo].[usp_load_dwh_dim_date]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_date];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_date]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    FROM (
        SELECT TRY_CAST(r.[Purchase_Date] AS DATE) AS full_date
        FROM [stg_computer_sales].[dbo].[raw_pc_data] AS r

        UNION

        SELECT TRY_CAST(r.[Ship_Date] AS DATE)
        FROM [stg_computer_sales].[dbo].[raw_pc_data] AS r
    ) AS dates
...
IF OBJECT_ID('[dbo].[usp_load_dwh_dim_channel]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_channel];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_channel]
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('[dbo].[usp_load_dwh_dim_customer_details]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_dim_customer_details];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_dim_customer_details]
AS
BEGIN
    SET NOCOUNT ON;

    INSERT INTO [dbo].[dim_customer_details] (
        customer_name,
        customer_surname,
...
IF OBJECT_ID('[dbo].[usp_load_all_dwh_dimensions]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_all_dwh_dimensions];
GO

CREATE PROCEDURE [dbo].[usp_load_all_dwh_dimensions]
AS
BEGIN
    SET NOCOUNT ON;
...
IF OBJECT_ID('[dbo].[usp_load_dwh_pc_sales_fact]', 'P') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_load_dwh_pc_sales_fact];
GO

CREATE PROCEDURE [dbo].[usp_load_dwh_pc_sales_fact]
AS
BEGIN
    SET NOCOUNT ON;
    ...
    INNER JOIN [dbo].[dim_priority_id] AS pr
